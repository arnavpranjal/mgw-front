...
export default function DealManagementForm() {
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Deal Summary">Deal Summary</option>
                      <option value="Phase Information">
                        Phase Information
                      </option>
                    </select>
                  </div>
            ...
            return (
              <TableRow key={feilds.id}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setEditFields({
                        ...
                        label: feilds.label,
                        subCategory:feilds.subCategory,
                      });
                ...
                <TableCell className="text-right">
                  <Checkbox
                    checked={
                      feilds.primary ? feilds.primary : feilds.requiredfield
                    }
                    disabled={feilds.primary}
                    onCheckedChange={(value) => {
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                name="subCategory"
                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                defaultValue={edidFields.subCategory}
                onChange={(e: any) =>
                  setEditFields({ ...edidFields, subCategory: e.target.value })
                }
             >
                <option value="">Select a Section</option>
                <option value="Deal Summary">Deal Summary</option>
                <option value="Phase Information">Phase Information</option>
              </select>
            </div>
