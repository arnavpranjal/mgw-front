  ...
  return (
    <div className="relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 ">
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        {/* bg-zinc-900 */}
        <div
          className="absolute inset-0 bg-cover bg-center w-full h-screen container-frost"
          style={{ backgroundImage: `url('/signin-bg.svg')` }}
        />
        <div className="relative z-20 flex items-center text-lg font-medium">
          ...
          <Image src="/LogoMergerware.svg" alt={""} width={195} height={195} />
          {/* Mergerware */}
        </div>
...
<br/><br/><br/><br/><br/><br/><br/> */}
          ...
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Thank You for simplifying your M&A process with
              Mergerware.&rdquo;
            </p>
      ...
      >
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px] ">
          ...
          <p className="px-8 text-center text-sm text-muted-foreground">
            ...
            <Link
              href="https://www.mergerware.com/terms-of-services/"
            ...
            and{" "}
            <Link
              href="https://www.mergerware.com/privacy-policy/"
              className="underline underline-offset-4 hover:text-primary"
            >
              Privacy Policy
            </Link>
          ...
          <Link
              ...
              className="underline underline-offset-4 text-primary hover:text-primary"
            >
              More info
            </Link>
          </p>
